    ...
    return (
        <div className={color} style={{height:'130vh'}}>
            ...
            <div className='leftbox'>
                ...
                <div className='imageBox' id='boxed-image'><img alt='' src={imageBox1}/></div>
                <br></br>
                <div className='author-name'>Author: {authOfImage1}</div>
            <br/>
            <br/>
                <button className='plus' id='add-image2' onClick={GoToSearchImages2}>+</button><br/>
                <div className='imageBox' id='boxed-image'><img alt='' src={imageBox2}/></div>
                <br></br>
            ...
            <div className='rightbox'>
                ...
                <div className='imageBox' id='boxed-image'><img alt='' src={imageBox3}/></div>
                <br></br>
                <div className='author-name'>Author: {authOfImage3}</div>
            <br/>
            <br/>
                <button className='plus' id='add-image4' onClick={GoToSearchImages4}>+</button><br/>
                <div className='imageBox' id='boxed-image'><img alt='' src={imageBox4}/></div>
                <br></br>
